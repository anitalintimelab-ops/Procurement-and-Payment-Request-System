...
# --- 5. 主功能流程 ---
menu = st.sidebar.radio("功能選單", ["1. 填寫申請單", "2. 簽核中心"])
    ...
    with st.form("apply_form"):
        ...
        if ed_data is not None:
            if str(ed_data["帳戶影像Base64"]) != "":
                st.image("data:image/jpeg;base64," + str(ed_data['帳戶影像Base64']), width=150); del_b = st.checkbox("🗑️ 刪除存摺")
