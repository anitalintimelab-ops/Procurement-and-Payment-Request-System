...
# --- 1. 系統大門設定 ---
st.set_page_config(page_title="時研-管理系統入口", layout="wide", page_icon="🏢", initial_sidebar_state="collapsed")

# [隱藏側邊欄 CSS] - 在登入前，強制左側選單消失
st.markdown("""
<style>
...
def load_staff():
    ...
    if df is None or df.empty:
        return pd.DataFrame({"name": ["Anita", "Andy", "Charles"], "password": ["0000"]*3, "status": ["在職"]*3})
    return df
