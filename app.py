    ...
    try:
        ...
        if not display_df.empty:
            ...
            if is_po_sys:
                ...
                display_df["本次請款金額"] = 0
                display_df["轉成請款單"] = display_df["轉成請款單"].astype(bool)
                display_df["本次請款金額"] = display_df["本次請款金額"].astype(int)
            ...
            display_df["請款狀態"] = display_df["請款狀態"].fillna("")
            display_df["已請款金額"] = display_df["已請款金額"].fillna(0).astype(int)
            display_df["尚未請款金額"] = display_df["尚未請款金額"].fillna(0).astype(int)
